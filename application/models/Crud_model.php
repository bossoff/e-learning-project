...
class Crud_model extends CI_Model
{
    ...
    //     if(is_array($pre_session) && !in_array($session_id, $pre_session)){
    //         if(is_array($pre_session) && count($pre_session) >= 1){
    //             $this->db->where('id', $pre_session[0]);
    //             $this->db->delete('ci_sessions');

    //             $count = 0;
    //             foreach($pre_session as $key => $all_pre_session){
    //                 if($key != 0):
    //                     array_push($session_id_arr, $all_pre_session);
    //                 endif;
    //                 $count++;
    //             }
    //             array_push($session_id_arr, $session_id);
    //         }else{
    //             if(is_array($pre_session)){
    //                 array_push($pre_session, $session_id);
    //                 $session_id_arr = $pre_session;
    //             }else{
    //                 $session_id_arr = [$session_id];
    //             }
    //         }
    //     }else{
    //         $session_id_arr = [$session_id];
    ...
    //     $data['session_id'] = json_encode($session_id_arr);
    //     $this->db->where('id', $id);
